...
cimport rpc_thrift.cython.cybinary_protocol
from rpc_thrift.cython.cybinary_protocol cimport TCyBinaryProtocol
...
class RpcServer(object):
    ...
    def loop_reader(self, transport, queue):
        cdef:
            TCyMemoryBuffer trans_input
            TCyBinaryProtocol proto_input
            double last_hb_time
            str name
            int type
            int32_t seqid
